...
;; Capa Pertenencia ;;
; Descripcion:  Verifica si el usuario ya esta registrado en el tablero.
...
;; Otras operaciones ;;
; Descripcion:  Función que permite retirar y voltear las dos cartas superiores del stack de cartas en el juego y las dispone en el área de juego.
; Dom: game(TDA)
; Rec: game(TDA)
(define stackMode
  (λ (gm)
...
;dobbleSet0
;dobbleSet1
(define game1(createGame 4 dobbleSet0 "stackMode" "randomFn" (tablero empyCardsSet (list (player "uwu" l1 1) (player "owo" l1 2) (player "ewe" l1 3) (player "awa" l1 4)) 1)))
(register "uwu" game1)
(ExcedeCantPlayers? game1)
